...
import com.dudu.smartagriculture.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @ApiOperation("获取指定用户信息，通过用户姓名")
    @RequestMapping(value = "/getUserInfoByName", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<UmsAdminUserInfoParam> getUserInfoByName(@RequestParam(value = "name") String name) {
        UmsAdminUserInfoParam admin = adminService.getUserInfoByName(name);
        if (admin != null) {
            return CommonResult.success(admin);
        }
        return CommonResult.failed();
